...
"""
    ...
    # /start menu
    START_MSG = "<tg-emoji emoji-id=\"5472055112702629499\">👋</tg-emoji> Привет, {first_name}!\n\nЯ бот для создания образовательных тестирований."
    ...
    MY_TESTS_TITLE = "<tg-emoji emoji-id=\"5470177992950946662\">👇</tg-emoji> Ваши тесты"
    ...
    # create test
    CREATE_TEST_PROMPT = "<tg-emoji emoji-id=\"5334673106202010226\">✏️</tg-emoji> Введите тему тестирования\n\nНапример:\n<code>Физика 8 класс, кипение воды</code>"
    ...
    TEST_CREATED_TEMPLATE = "<tg-emoji emoji-id=\"5427009714745517609\">✅</tg-emoji> <b>Тестирование создано</b>\n\nСсылка для прохождения теста:\n{test_link}"
